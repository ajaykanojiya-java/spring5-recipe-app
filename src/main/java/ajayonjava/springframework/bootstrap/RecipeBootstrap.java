package ajayonjava.springframework.bootstrap;

import ajayonjava.springframework.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipe(){
        ...
        //now no need of below setter because recipe class has setNotes() which takes care of bidirectional mapping.
        //guacNotes.setRecipe(guacRecipe); //to add a recipe id as a foreign key, need to set recipe in Notes.
        ...
        //tacoNotes.setRecipe(tacosRecipe); //it will add a foreign key (recipe id) in Notes table
